...
class AdventureSports(models.Model):
	activity_name=models.CharField(max_length=200,blank=False)
	location=models.CharField(max_length=200,blank=False)
	state=models.CharField(max_length=100,blank=False)
	description=models.TextField(blank=False)
	price_range=models.CharField(max_length=100,blank=False)
	difficulty_choices=(('Easy','Easy'),('Moderate','Moderate'),('Hard','Hard'),('Expert','Expert'))
	difficulty=models.CharField(max_length=50,blank=False,choices=difficulty_choices)
	best_season=models.CharField(max_length=100,blank=False)
	image_url=models.CharField(max_length=300,blank=True,default="")
	class Meta:
		db_table="adventure_sports"

# New model to store booked tickets
class BookedTicket(models.Model):
	user_email=models.EmailField(blank=False)
	ticket_type=models.CharField(max_length=20,blank=False)  # Bus or Flight
	travels_name=models.CharField(max_length=100,blank=False)
	departure_place=models.CharField(max_length=50,blank=False)
	arrival_place=models.CharField(max_length=50,blank=False)
	departure_time=models.CharField(max_length=10,blank=False)
	arrival_time=models.CharField(max_length=10,blank=False)
